...
Invoke-Step "Safe WhatsApp prompt coverage" {
    pnpm exec vitest run `
        ...
        --testNamePattern "text message .* agent loop|what can you do|WhatsApp self-test|sets clear WhatsApp reminders|logs plain text expenses|answers exact pending items"
}
