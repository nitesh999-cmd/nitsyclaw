...
pnpm exec vitest run `
    ...
    --testNamePattern "Saved|working receipt|what can you do|ready pending setup status|pending items|provider readiness|capability|self-test|incident summary"
