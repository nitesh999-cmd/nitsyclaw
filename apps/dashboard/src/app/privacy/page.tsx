  ...
  return (
    <main className="mx-auto max-w-3xl space-y-6 p-4 text-slate-200 md:p-8">
      ...
      <section className="space-y-3 text-sm leading-6 text-slate-300">
        <h2 className="text-lg font-medium text-white">What NitsyClaw stores</h2>
        <p>
      ...
      <section className="space-y-3 text-sm leading-6 text-slate-300">
        <h2 className="text-lg font-medium text-white">Provider accounts</h2>
        <p>
      ...
      <section className="space-y-3 text-sm leading-6 text-slate-300">
        <h2 className="text-lg font-medium text-white">What delete does</h2>
        <p>
