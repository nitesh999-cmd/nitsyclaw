  ...
  return (
    <main className="mx-auto max-w-3xl space-y-6 p-4 text-stone-800 md:p-8">
      ...
      <section className="space-y-3 text-sm leading-6 text-stone-700">
        <h2 className="text-lg font-medium text-stone-950">What NitsyClaw stores</h2>
        <p>
      ...
      <section className="space-y-3 text-sm leading-6 text-stone-700">
        <h2 className="text-lg font-medium text-stone-950">Provider accounts</h2>
        <p>
      ...
      <section className="space-y-3 text-sm leading-6 text-stone-700">
        <h2 className="text-lg font-medium text-stone-950">What delete does</h2>
        <p>
