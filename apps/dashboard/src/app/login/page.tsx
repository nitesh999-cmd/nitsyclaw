        ...
        <div className="flex flex-col justify-between gap-10">
          ...
          <div className="grid gap-3 text-sm sm:grid-cols-3">
            <div className="rounded-xl border border-slate-700 bg-slate-800/60 p-3">
              <div className="text-xs font-semibold text-[#d8b75d]">Private</div>
              <div className="mt-2 text-slate-200">Owner-gated</div>
            </div>
            <div className="rounded-xl border border-slate-700 bg-slate-800/60 p-3">
              <div className="text-xs font-semibold text-[#d8b75d]">Saved</div>
              <div className="mt-2 text-slate-200">Private records</div>
            </div>
            <div className="rounded-xl border border-slate-700 bg-slate-800/60 p-3">
              <div className="text-xs font-semibold text-[#d8b75d]">Useful</div>
