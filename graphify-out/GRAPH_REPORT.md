...
## Corpus Check
- 237 files · ~111,368 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 681 nodes · 1421 edges · 18 communities detected
...
Cohesion: 0.06
Nodes (51): runAgent(), pinMemory(), recallMemory(), ToolRegistry, zodToJsonSchema(), insertExpense(), insertMemory(), restorePendingConfirmation() (+43 more)
...
Cohesion: 0.1
Nodes (18): dueReminders(), insertReminder(), logAudit(), markReminderFired(), redactAuditString(), sanitizeAuditPayload(), sanitizeAuditValue(), upsertBrief() (+10 more)
...
- **Thin community `Community 16`** (5 nodes): `NoopWhatsApp`, `.destroy()`, `.onMessage()`, `.ready()`, `.send()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 17`** (4 nodes): `DashboardShell()`, `RootLayout()`, `dashboard-shell.tsx`, `layout.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `getDb()` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 5`, `Community 12`, `Community 13`?**
  _High betweenness centrality (0.268) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 2` to `Community 8`, `Community 4`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `requireSameOrigin()` connect `Community 1` to `Community 12`, `Community 4`, `Community 5`?**
